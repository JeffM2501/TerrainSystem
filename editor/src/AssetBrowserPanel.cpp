...
void AssetBrowserPanel::ShowFilePane()
{
    ...
    if (item)
    {
        ...
        if (assetItem->IsFile())
        {
            //             DocumentSytem* system = EditorApp::Get().GetSystem<DocumentSytem>();
            //             if (system)
            //             {
            //                 FileInfo* file = static_cast<FileInfo*>(assetItem);
            //                 const char* extension = GetFileExtension(file->FullPath.c_str());
            //                 if (extension == nullptr)
            //                     extension = "";
            // 
            //                 system->Open(extension, file->FullPath);
            //             }
        }
        else
        {
